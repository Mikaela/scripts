...
pip install -vr https://raw.githubusercontent.com/ProgVal/Limnoria/testing/requirements.txt --upgrade $NOROOT $1
...
pip install -v git+https://github.com/ProgVal/Limnoria.git@testing --upgrade $NOROOT $1
